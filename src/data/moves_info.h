...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_FREEZE_SHOCK] =
    {
        ...
        .sleepTalkBanned = TRUE,
        .instructBanned = TRUE,
        .argument.twoTurnAttack = { .stringId = STRINGID_CLOAKEDINAFREEZINGLIGHT, .weather = B_WEATHER_ICY_ANY },
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_PARALYSIS,
            .chance = 30,
        }),
    ...
    [MOVE_PRECIPICE_BLADES] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "attack both foes."),
        .effect = EFFECT_PRECIPICE_BLADES,
        .power = 120,
        .type = TYPE_GROUND,
        .accuracy = 85,
        .pp = 10,
    ...
    [MOVE_METEOR_BEAM] =
    {
        ...
        .sleepTalkBanned = TRUE,
        .instructBanned = TRUE,
        .argument.twoTurnAttack = { .stringId = STRINGID_METEORBEAMCHARGING, .weather = B_WEATHER_SANDSTORM },
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_STAT_PLUS,
            .spAtk = 1,
            .self = TRUE,
    ...
    [MOVE_RAIN_BLOOM] =
    {
        .name = COMPOUND_STRING("Rain Bloom"),
        .description = COMPOUND_STRING(
            "Power doubles when\n"
            "rain is falling."),
        .effect = EFFECT_RAIN_BLOOM,
        .power = 70,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_SCATTER_MIST] =
    {
        .name = COMPOUND_STRING("Scatter Mist"),
        .description = COMPOUND_STRING(
            "Lowers the foe's Attack\n"
            "and Sp. Atk before it moves."),
        .effect = EFFECT_STAT_CHANGE,
        .power = 0,
        .type = TYPE_BUG,
        .accuracy = 0,
    ...
    [MOVE_WING_SMASH] =
    {
        .name = COMPOUND_STRING("Wing Smash"),
        .description = COMPOUND_STRING(
            "A forceful wing strike\n"
            "that may lower Defense."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FLYING,
    ...
    [MOVE_IRON_BLADE] =
    {
        .name = COMPOUND_STRING("Iron Blade"),
        .description = COMPOUND_STRING(
            "A sharp steel strike.\n"
            "High critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_STEEL,
    ...
    [MOVE_SWARM_WAVE] =
    {
        .name = COMPOUND_STRING("Swarm Wave"),
        .description = COMPOUND_STRING(
            "Power increases 50% if\n"
            "Grassy Terrain is active."),
        .effect = EFFECT_SWARM_WAVE,
        .power = 100,
        .type = TYPE_BUG,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_STAMPEDE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A charging steel attack\n"
            "that destroys the terrain."),
        .effect = EFFECT_ICE_SPINNER,
        .power = 120,
        .type = TYPE_STEEL,
        .accuracy = 90,
    ...
    [MOVE_VOLTAGE_CLASH] =
    {
        .name = COMPOUND_STRING("Voltage Clash"),
        .description = COMPOUND_STRING(
            "An electric strike that\n"
            "ignores evasiveness changes."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_AIR_CLASH] =
    {
        .name = COMPOUND_STRING("Air Clash"),
        .description = COMPOUND_STRING(
            "The user unleashes\n"
            "air blasts. May paralyze."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FLYING,
        .accuracy = 95,
    ...
    [MOVE_AQUATIC_SLAM] =
    {
        .name = COMPOUND_STRING("Aquatic Slam"),
        .description = COMPOUND_STRING(
            "The user slams the foe\n"
            "with immense water force."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_WATER,
        .accuracy = 85,
    ...
    [MOVE_POWER_CONSTRAIN] =
    {
        .name = COMPOUND_STRING("Power Constrict"),
        .description = COMPOUND_STRING(
            "The user constricts the\n"
            "foe. May lower Speed."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_GRASS,
    ...
    [MOVE_PSYCHIC_OVERLOAD] =
    {
        .name = COMPOUND_STRING("Psychic Overload"),
        .description = COMPOUND_STRING(
            "A reckless attack that\n"
            "lowers Def. and Sp. Def."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    [MOVE_PYROCLASTIC_FLOW] =
    {
        .name = COMPOUND_STRING("Pyroclastic Flow"),
        .description = COMPOUND_STRING(
            "A searing blast that may\n"
            "burn and lowers Speed."),
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_IRON_HEAT] =
    {
        .name = COMPOUND_STRING("Iron Heat"),
        .description = COMPOUND_STRING(
            "A blazing steel attack.\n"
            "Power increases in sun."),
        .effect = EFFECT_IRON_HEAT,
        .power = 95,
        .type = TYPE_STEEL,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_CORROSION_BURST] =
    {
        .name = COMPOUND_STRING("Corrosion Burst"),
        .description = COMPOUND_STRING(
            "A caustic blast that's\n"
    ...
    [MOVE_EXOSHELL] =
    {
        .name = COMPOUND_STRING("Exoshell"),
        .description = COMPOUND_STRING(
            "Boosts Defense and the\n"
            "next Bug move used."),
        .effect = EFFECT_EXOSHELL,
        .power = 0,
        .type = TYPE_BUG,
        .accuracy = 0,
        .pp = 20,
    ...
    [MOVE_DARK_MIND] =
    {
        .name = COMPOUND_STRING("Dark Mind"),
        .description = COMPOUND_STRING(
            "A sinister blast. May lower\n"
            "the target's Sp. Def."),
        .effect = EFFECT_HIT,
        .power = 110,
        .type = TYPE_DARK,
    ...
    [MOVE_DIRE_DANCE] =
    {
        .name = COMPOUND_STRING("Dire Dance"),
        .description = COMPOUND_STRING(
            "Dances to raise Sp. Atk\n"
            "Sp. Def and Speed."),
        .effect = EFFECT_STAT_CHANGE,
    ...
    [MOVE_LIGHTS_OUT] =
    {
        .name = COMPOUND_STRING("Lights Out"),
        .description = COMPOUND_STRING(
            "An attack that absorbs\n"
            "half the damage inflicted."),
        .effect = EFFECT_ABSORB,
    ...
    [MOVE_DRAGON_SHIELD] =
    {
        .name = COMPOUND_STRING("Dragon Shield"),
        .description = COMPOUND_STRING(
            "Raises Defense and Sp. Def\n"
            "with a dragon's aura."),
        .effect = EFFECT_STAT_CHANGE,
        .power = 0,
        .type = TYPE_DRAGON,
        .accuracy = 0,
    ...
    [MOVE_FEY_HAMMER] =
    {
        .name = COMPOUND_STRING("Fey Hammer"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MYSTIC_WAVE] =
    {
        .name = COMPOUND_STRING("Mystic Wave"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOLAR_CLAW] =
    {
        .name = COMPOUND_STRING("Solar Claw"),
        .description = COMPOUND_STRING(
            "Charges first turn, then\n"
            "strikes with searing claws."),
        .effect = EFFECT_SOLAR_BEAM,
        .power = 120,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_GHASTLY_WALL] =
    {
        .name = COMPOUND_STRING("Ghastly Wall"),
        .description = COMPOUND_STRING(
            "A wall of spirits crashes\n"
            "over all other Pokemon."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_PHANTOM_GRIP] =
    {
        .name = COMPOUND_STRING("Phantom Grip"),
        .description = COMPOUND_STRING(
            "A spectral hand grips the\n"
    ...
    [MOVE_SHADOW_SPASM] =
    {
        .name = COMPOUND_STRING("Shadow Spasm"),
        .description = COMPOUND_STRING(
            "User's highest attack stat\n"
            "determines its category."),
        .effect = EFFECT_PHOTON_GEYSER,
    ...
    [MOVE_DUST_STORM] =
    {
        .name = COMPOUND_STRING("Dust Storm"),
        .description = COMPOUND_STRING(
            "Throws scorching sand at\n"
            "the target. May leave a burn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_GEO_SPHERE] =
    {
        .name = COMPOUND_STRING("Geo Sphere"),
        .description = COMPOUND_STRING(
            "Hits Flying types and\n"
            "grounds them."),
        .effect = EFFECT_SMACK_DOWN,
        .power = 70,
        .type = TYPE_GROUND,
    ...
    [MOVE_DRY_ICE] =
    {
        .name = COMPOUND_STRING("Dry Ice"),
        .description = COMPOUND_STRING(
            "A frigid blast that may\n"
            "inflict a burn."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_ICE,
    ...
    [MOVE_FROST_CLAW] =
    {
        .name = COMPOUND_STRING("Frost Claw"),
        .description = COMPOUND_STRING(
            "An icy strike that absorbs\n"
            "half the damage inflicted."),
        .effect = EFFECT_ABSORB,
        .power = 120,
        .type = TYPE_ICE,
    ...
    [MOVE_GLACIER_CRASH] =
    {
        .name = COMPOUND_STRING("Glacier Crash"),
        .description = COMPOUND_STRING(
            "A crashing glacier strikes\n"
            "all other Pokemon."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_ICE,
    ...
    [MOVE_ICE_BURST] =
    {
        .name = COMPOUND_STRING("Ice Burst"),
        .description = COMPOUND_STRING(
            "User's highest attack stat\n"
            "determines its category."),
        .effect = EFFECT_PHOTON_GEYSER,
    ...
    [MOVE_ICE_STATIC] =
    {
        .name = COMPOUND_STRING("Ice Static"),
        .description = COMPOUND_STRING(
            "A charged frost that may\n"
            "paralyze the foe."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_ICE,
    ...
    [MOVE_TOXIC_SPECTRUM] =
    {
        .name = COMPOUND_STRING("Toxic Spectrum"),
        .description = COMPOUND_STRING(
            "Boosts the power of the\n"
            "next Poison move used."),
        .effect = EFFECT_TOXIC_SPECTRUM,
        .power = 0,
        .type = TYPE_POISON,
        .accuracy = 0,
        .pp = 20,
    ...
    [MOVE_VENOM_SNARE] =
    {
        .name = COMPOUND_STRING("Venom Snare"),
        .description = COMPOUND_STRING(
            "Strikes first if the foe\n"
            "is preparing an attack."),
        .effect = EFFECT_SUCKER_PUNCH,
    ...
    [MOVE_TELEPATHIC_WAVE] =
    {
        .name = COMPOUND_STRING("Telepathic Wave"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_DIAMOND_CLAW] =
    {
        .name = COMPOUND_STRING("Diamond Claw"),
        .description = COMPOUND_STRING(
            "A crystalline strike that\n"
            "absorbs half the damage."),
        .effect = EFFECT_ABSORB,
        .power = 80,
        .type = TYPE_ROCK,
    ...
    [MOVE_JEWEL_FLASH] =
    {
        .name = COMPOUND_STRING("Jewel Flash"),
        .description = COMPOUND_STRING(
            "A blinding glare of gems\n"
    ...
    [MOVE_STONE_STRIKE] =
    {
        .name = COMPOUND_STRING("Stone Strike"),
        .description = COMPOUND_STRING(
            "A jagged blow that may\n"
            "paralyze the foe."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_ROCK,
    ...
    [MOVE_METAL_SHOCK] =
    {
        .name = COMPOUND_STRING("Metal Shock"),
        .description = COMPOUND_STRING(
            "A jolt of charged metal\n"
            "that may paralyze the foe."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_STEEL,
    ...
    [MOVE_PRISM_EDGE] =
    {
        .name = COMPOUND_STRING("Prism Edge"),
        .description = COMPOUND_STRING(
            "A sharp metal blast.\n"
            "High critical-hit ratio."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_TSUNAMI] =
    {
        ...
        .description = COMPOUND_STRING(
            "A massive wave that may\n"
            "lower the foes' Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = 110,
        .type = TYPE_WATER,
        .accuracy = 80,
