...
enum __attribute__((packed)) Move
{
    ...
    MOVE_QUICKSAND = 848,
    MOVE_RAIN_BLOOM = 849,
    MOVE_SCATTER_MIST = 850,
    MOVE_WING_SMASH = 851,
    MOVE_PSYBLAST = 852,
    MOVE_IRON_BLADE = 853,
    MOVE_SWARM_WAVE = 854,
    MOVE_STAMPEDE = 855,
    MOVE_VOLTAGE_CLASH = 856,
    MOVE_AIR_CLASH = 857,
    MOVE_AQUATIC_SLAM = 858,
    MOVE_BEAR_HUG = 859,
    MOVE_POWER_CONSTRAIN = 860,
    MOVE_PSYCHIC_OVERLOAD = 861,
    MOVE_PYROCLASTIC_FLOW = 862,
    MOVE_PSYBOLT = 863,
    MOVE_IRON_HEAT = 864,
    MOVE_CORROSION_BURST = 865,
    MOVE_EXOSHELL = 866,
    MOVE_DARK_MIND = 867,
    MOVE_DIRE_DANCE = 868,
    MOVE_LIGHTS_OUT = 869,
    MOVE_DRAGON_SHIELD = 870,
    MOVE_PULSING_WAVE = 871,
    MOVE_FEY_HAMMER = 872,
    MOVE_MYSTIC_WAVE = 873,
    MOVE_SOLAR_CLAW = 874,
    MOVE_CYCLONE = 875,
    MOVE_SKY_DASH = 876,
    MOVE_GHASTLY_WALL = 877,
    MOVE_PHANTOM_GRIP = 878,
    MOVE_SHADOW_SPASM = 879,
    MOVE_DUST_STORM = 880,
    MOVE_GEO_SPHERE = 881,
    MOVE_DRY_ICE = 882,
    MOVE_FROST_CLAW = 883,
    MOVE_GLACIER_CRASH = 884,
    MOVE_ICE_BURST = 885,
    MOVE_ICE_STATIC = 886,
    MOVE_TOXIC_SPECTRUM = 887,
    MOVE_VENOM_SNARE = 888,
    MOVE_MIND_PRESS = 889,
    MOVE_TELEPATHIC_WAVE = 890,
    MOVE_TYPHOON = 891,
    MOVE_DIAMOND_CLAW = 892,
    MOVE_JEWEL_FLASH = 893,
    MOVE_STONE_STRIKE = 894,
    MOVE_METAL_SHOCK = 895,
    MOVE_PRISM_EDGE = 896,
    MOVE_TSUNAMI = 897,
    MOVES_COUNT_GEN9,
